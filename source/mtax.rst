...
1. خرید لایسنس ارسال صورتحساب به سامانه مودیان برای نرم افزار فاکتور.
...
2. استفاده از سرویس آنلاین سامانه مودیان.
    
    این سامانه برای ارسال نیاز به لایسنس ندارد، و هزینه ارسال در آن بصورت تکی و برای هر ارسال از موجودی کیف پول شما در سایت کم خواهد شد. همچنین محدودیتی در ثبت صادرکننده برای آن وجود ندارد.
    برای استفاده از این سامانه علاوه بر استفاده مستقیم و تحت وب مستقل از نرم افزار فاکتور امکان دیگری برای ارسال صورتحساب از نرم افزار فاکتور توسط گزینه "ارسال با سامانه آنلاین" در پنجره ارسال صورتحساب وجود دارد که در ادامه توضیح داده شده است.
...
.. |mtax| raw:: html
    ...
    <a href="https://mtax.mohsensoft.com" target="_blank">https://mtax.mohsensoft.com</a>
...
|newflag| **ارسال با سامانه آنلاین :** با انتخاب این گزینه اطلاعات وارد شده در این پنجره به سامانه آنلاین منتقل میشود و نیازی به وارد کردن آنها در سامانه آنلاین نیست.
...
|newflag| با انتخاب منوی سه خط این پنجره گزینه های زیر نمایش داده میشود:

.. image:: images/mtax_menu.png
    :alt:  منوی ارسال به سامانه مودیان
    :align: center
