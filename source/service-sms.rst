...
.. rst-class:: ms-highlight-rtl highlight
    ...
    | ==مشتری.نام== عزیز
    | بدهی شما تا این لحظه مقدار ==فاکتور.جمع== ==فاکتور.واحد پول== میباشد.
    | ==مشخصات.نام==
    |
    | **خروجی:**
    | محمد محمدی عزیز
    | بدهی شما تا این لحظه مقدار 45,000,000 ریال میباشد.
    | کافی نت پارسه
...
توسط گزینه های جهت دار بالای لیست میتوانید ترتیب لیست را تغییر دهید، این ترتیب همان ترتیب نمایش آنها در قسمت :ref:`نوار پیامک<bar-sms>` از پنجره اصلی برای دسترسی سریع هستند.
