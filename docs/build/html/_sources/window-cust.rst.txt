...
|newflag| **ستونهای جدول نتیجه جستجو :** با استفاده از این منو میتوانید انتخاب کنید چه فیلدهایی در جدول نتیجه جستجو نمایش داده شوند.

|newflag| **فیلدهای جستجو :** توسط این منو میتوانید مشخص کنید در هنگام جستجو در چه فیلدهایی عمل جستجو انجام شود.